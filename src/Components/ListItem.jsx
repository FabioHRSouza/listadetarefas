        ...
        <div>
            {
                ...
                finalizado ? (
                    ...
                    <li key={tarefa.id} className={'list-item finalizado'}>
                        {tarefa.texto}
                        <button className="list-item-button-finalizar" onClick={finalizarTarefa}>Concluido</button>
                        <button className="list-item-button-remover" onClick={handleRemoverTarefa}>Excluir</button>
                    </li>
                ) : (
                    // li sem marcação de finalizado
                    <li key={tarefa.id} className={'list-item'}>
                        {tarefa.texto}
                        <button className="list-item-button-finalizar" onClick={finalizarTarefa}>Finalizar</button>
                        <button className="list-item-button-remover" onClick={handleRemoverTarefa}>Excluir</button>
                    </li>
                )
            }
